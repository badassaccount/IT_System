    <!-- main content -->
      ...
      <section
        ...
        class="flex min-h-0 flex-col flex-auto border-l"
      >
        <!-- content navigation -->
        <nav class="bg-gray-100 flex p-4">
          ...
          >
            ...
            <ul class="flex">
              ...
              <li>
                <button
                  class="focus:outline-none focus:bg-yellow-200 p-2 border rounded-r-md bg-white flex flex-col items-center w-24 cursor-pointer"
                >
          ...
          <section aria-labelledby="ticket-statistics-tabs-label" class="pb-2">
            ...
            <ul class="flex">
              ...
              <li>
                <button
                  class="focus:outline-none focus:bg-yellow-200 p-2 border border-r-0 bg-white flex flex-col items-center w-24"
                >
              ...
              <li>
                <button
                  class="focus:outline-none focus:bg-yellow-200 p-2 border rounded-r-md bg-white flex flex-col items-center w-24"
                >
        ...
        <header class="bg-white border-t flex items-center py-1 px-4">
          <div class="flex">
            ...
            <span class="ml-3 group relative">
              ...
              >
                <div
                  class="border rounded-md rounded-t-lg shadow-lg bg-white w-full max-w-xs w-screen"
                >
                  <header
                    class="font-semibold rounded-t-lg bg-gray-300 px-4 py-2"
                  >
        ...
        >
          ...
          <tbody
            class="flex w-full flex-col flex-1 min-h-0 overflow-hidden px-4"
          >
            <!-- low -->
            <tr class="border-b flex">
            ...
            <tr
              role="row"
              class="hover:bg-blue-100 border-b flex cursor-pointer"
            >
              <td
                role="cell"
                headers="select"
                class="py-3 pl-3 pr-1 w-24 flex items-start"
              >
                ...
                <div class="ml-auto relative group">
                  ...
                  <!-- dropdown -->
                  <span
                    class="hidden group-hover:block ml-4 mt-10 w-screen max-w-lg absolute top-0 border shadow-lg p-6 bg-white rounded-md z-50 text-gray-900"
                  >
                    <article>
                      <header>
                        <div>
                          <span
                            class="px-3 py-1 uppercase text-xs leading-none rounded-sm bg-red-600 text-white"
                            >Open</span
                          >
                    ...
                    <article>
                      ...
                      <section class="mt-5">
                        ...
                        <p class="mt-3">
                          ...
                          doloremque. <br /><br />
                          Lorem ipsum dolor sit amet consectetur, adipisicing
                          elit. Odit consequatur natus aut reiciendis nisi sed!
                          Temporibus, quibusdam voluptates? ...
                        </p>
                      </section>
                      <footer class="mt-4">
                        <p class="text-gray-600">Latest Comments</p>
                        ...
                        <p class="mt-2">
                          Dolore odio error inventore sint et dolorum asperiores
                          exercitationem, quisquam esse tempora aliquam
                          voluptates quibusdam quae debitis laboriosam iure ea
                          quos.
                        </p>
                      </footer>
                    </article>
                  ...
                  >
                    <article>
                      <header>
                        <div>
                          <span
                            class="px-3 py-1 uppercase text-xs leading-none rounded-sm bg-yellow-400 text-black"
                            >New</span
                          >
                          <span class="ml-2 text-gray-700"
                            >Incident #12534</span
                    ...
                    <article>
                      ...
                      <footer class="mt-4">
                        ...
                        <div class="flex mt-3">
                          ...
                          <p
                            aria-label="time"
                            class="ml-auto text-gray-700 text-sm"
                          >
                            Today 06:34
                          </p>
                        </div>
                        <p aria-label="comment" class="mt-2">
                          ...
                          blanditiis culpa dolor provident perferendis sapiente
                          corrupti repudiandae ea dolore.
                        </p>
                      </footer>
                    </article>
                  </span>
